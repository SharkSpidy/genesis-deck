...
const GAINS = [
  ...
  { title: 'A genuinely full campus, for days', copy: 'Eleven concurrent competitions mean sustained energy and footfall across the whole venue, not one isolated evening.' },
  ...
  { title: 'A tech-forward positioning', copy: 'A 300-participant hackathon, judged live with an IT Minister on the floor, is a concrete claim to make in admissions and outreach material.' },
